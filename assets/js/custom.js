(function ($) {
  ...
  // About Style3 Tab
  if ($('.about-style3__tab').length) {
    $('.about-style3__tab .tabs-button-box .tab-btn-item').on('click', function (e) {
      e.preventDefault();
      ...
      if ($(target).hasClass('actve-tab')) {
        ...
        $('.about-style3__tab .tabs-button-box .tab-btn-item').removeClass('active-btn-item');
        $(this).addClass('active-btn-item');
        $('.about-style3__tab .tabs-content-box .tab-content-box-item').removeClass('tab-content-box-item-active');
  ...
  // About Style4 Tab
  if ($('.insurance-calculator__tab').length) {
    $('.insurance-calculator__tab .tabs-button-box .tab-btn-item').on('click', function (e) {
      e.preventDefault();
      var target = $($(this).attr('data-tab'));
      ...
      if ($(target).hasClass('actve-tab')) {
        ...
        $('.insurance-calculator__tab .tabs-button-box .tab-btn-item').removeClass('active-btn-item');
        $(this).addClass('active-btn-item');
        $('.insurance-calculator__tab .tabs-content-box .tab-content-box-item').removeClass('tab-content-box-item-active');
        $(target).addClass('tab-content-box-item-active');
      }
    });
  }
  ...
  // Statements Style1 Tab
  if ($('.statements-style1__tab').length) {
    $('.statements-style1__tab .tabs-button-box .tab-btn-item').on('click', function (e) {
      e.preventDefault();
      var target = $($(this).attr('data-tab'));
      ...
      if ($(target).hasClass('actve-tab')) {
        ...
        $('.statements-style1__tab .tabs-button-box .tab-btn-item').removeClass('active-btn-item');
        $(this).addClass('active-btn-item');
        $('.statements-style1__tab .tabs-content-box .tab-content-box-item').removeClass('tab-content-box-item-active');
        $(target).addClass('tab-content-box-item-active');
      }
    });
  }
  ...
  // About Style4 Tab
  if ($('.features-box__tab').length) {
    $('.features-box__tab .tabs-button-box .tab-btn-item').on('click', function (e) {
      e.preventDefault();
      var target = $($(this).attr('data-tab'));
      ...
      if ($(target).hasClass('actve-tab')) {
        ...
        $('.features-box__tab .tabs-button-box .tab-btn-item').removeClass('active-btn-item');
        $(this).addClass('active-btn-item');
        $('.features-box__tab .tabs-content-box .tab-content-box-item').removeClass('tab-content-box-item-active');
        $(target).addClass('tab-content-box-item-active');
      }
    });
  }
  ...
  // Faq Page Tab
  if ($('.faq-page__tab').length) {
    $('.faq-page__tab .tabs-button-box .tab-btn-item').on('click', function (e) {
      e.preventDefault();
      var target = $($(this).attr('data-tab'));
      ...
      if ($(target).hasClass('actve-tab')) {
        ...
        $('.faq-page__tab .tabs-button-box .tab-btn-item').removeClass('active-btn-item');
        $(this).addClass('active-btn-item');
        $('.faq-page__tab .tabs-content-box .tab-content-box-item').removeClass('tab-content-box-item-active');
        $(target).addClass('tab-content-box-item-active');
      }
    });
  }
  ...
  $(window).on("load", function () {
    ...
    // Curved Circle
    if ($('.about-style3__curved-circle').length) {
      $('.about-style3__curved-circle').circleType({
        position: 'absolute',
        dir: 1,
        radius: 73,
        forceHeight: true,
    ...
    if ($('.video-play-button-style1__top').length) {
      $('.video-play-button-style1__top').circleType({
        position: 'absolute',
        dir: 1,
        radius: 65,
        fitText: false,
    ...
    //Jquery Curved Circle
    if ($('.video-play-button-style1__bottom').length) {
      $('.video-play-button-style1__bottom').circleType({
        position: 'absolute',
        dir: -1,
        radius: 65,
        forceHeight: true,
    ...
    // Curved Circle
    if ($('.get-quote-box .title').length) {
      $('.get-quote-box .title').circleType({
        position: 'absolute',
        dir: 1,
        radius: 110,
        forceHeight: true,
